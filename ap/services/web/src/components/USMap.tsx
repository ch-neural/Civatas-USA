 ...
 *
 * Values are keyed by FIPS code instead of human names (because county
 * names like "Adams County" exist in many states):
 *
        ...
        {features.map((feature: any) => {
          ...
          return (
            <path
              ...
              onMouseMove={(e) => handleMouseMove(e, name, (val ?? null) as any)}
              onMouseLeave={() => {
                setHovered(null);
                setTooltip(null);
                onFeatureHover?.(null);
